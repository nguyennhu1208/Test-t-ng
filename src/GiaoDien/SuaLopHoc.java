...
public class SuaLopHoc extends JInternalFrame {
    ...
    public SuaLopHoc() {
        ...
        setTitle("TEST TỰ ĐỘNG - SỬA LỚP HỌC");
        setClosable(true);
        setResizable(true);
        setMaximizable(true);
        setSize(900, 500);
        ...
        model = new DefaultTableModel(
                new Object[]{"STT", "Mã lớp", "Tên mới", "Kết quả"}, 0);
    ...
    private void runTest() {
        ...
        SwingWorker<Void, Object[]> worker = new SwingWorker<Void, Object[]>() {
            ...
            protected Void doInBackground() throws Exception {
                ...
                SuaLopHocService.runTest(url, excel, new SuaLopHocService.LopHocCallback() {

                    @Override
                    public void onRowResult(int stt, String ma, String tenMoi, String result) {
                        publish(new Object[]{stt, ma, tenMoi, result});
                    }
            ...
            protected void done() {
                ...
                JOptionPane.showMessageDialog(SuaLopHoc.this, "Test hoàn thành!");
            }
        };
